...
const feedbackUrl = 'https://github.com/chaoslightnight11-sys/Quant/issues/new?template=feedback.yml';
...
function App() {
  ...
  return <>
    ...
    <main>
      ...
      <section className="dashboard" id="dashboard">
        ...
        <div className="panels">
          ...
          <article className="risk"><div className="paneltitle"><h3>Risk radarı</h3><BarChart3 size={20}/></div><div className="riskrow"><span>İlk 3 varlık yoğunluğu</span><b>{stats.concentration.toFixed(0)}%</b></div><div className="meter"><i style={{width:`${stats.concentration}%`}}/></div><div className="insight"><Sparkles size={18}/><p><b>Quant içgörüsü</b>{stats.concentration>70?'Portföyünün büyük bölümü üç varlıkta. Yeni yatırımları farklı sektörlere yönlendirmek dalgalanmayı azaltabilir.':'Dağılımın dengeli görünüyor. Sektör ağırlıklarını düzenli kontrol etmeye devam et.'}</p></div><a className="report" href={betaUrl} target="_blank" rel="noreferrer" onClick={()=>track('beta_intent', { placement: 'dashboard' })}>Pro beta listesine katıl <ArrowRight size={17}/></a></article>
        </div>
      </section>
    ...
    <footer id="privacy"><a className="brand" href="#"><span>Q</span> Quantfolio</a><p>Yatırım tavsiyesi değildir. Portföy verileri cihazınızda işlenir.</p><span><a href="privacy.html">Gizlilik</a> · <a href="terms.html">Koşullar</a> · <a href={feedbackUrl} target="_blank" rel="noreferrer">Geri bildirim</a></span><small>© 2026 Quantfolio</small></footer>
  </>;
}
